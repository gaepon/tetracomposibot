...
class Robot_player(Robot):
    ...
    def genetic(self, sensors, sensor_view=None, sensor_to_robot=None, sensor_to_wall=None, sensor_robot=None, sensor_team=None):
        ...
        ### Final Training's result ###
        param_trans = [0, -0.9060423268062632, 0, 0, -0.369150995049777, -0.11025694978414693, -0.13608530048230977, 0, 0.06425465146749498, 0, 0, 0, 0, 0, 0.49233485835425456, -0.1865479831711429, 0]
        param_rot = [-0.15252084747925154, 0, 0.07574501967759956, 0, 0, 0.013922718223420514, -0.17174656609723687, 0, 0, 0.08529376208718722, 0, 0, 0, -0.09089573877212354, 0, -0.05895233204147219, 0]
